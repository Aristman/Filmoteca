...
dependencies {
    ...
    implementation("androidx.room:room-paging:2.4.0-alpha04") // Оставлять эту версию бибилиотеки. Иначе конфликт версий. Краш
    ...
    implementation("androidx.paging:paging-compose:1.0.0-alpha12") // Оставлять эту версию бибилиотеки. Иначе конфликт версий. Краш
